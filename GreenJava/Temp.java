...
public class Temp extends JFrame {
	...
	public Temp() {
		...
		inputSpace.setBackground(Color.GRAY);
	...
	class PadActionListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			if (operation.equals("C")) {
				...
				} else if (!inputSpace.getText().equals("") && !inputSpace.getText().equals("+")
	...
	private void fullTextPasing(String inputText) {
		equation.clear();
	...
	public double calculate(String inputText) {
		...
		for (int i = 0; i < equation.size(); i++) {
			...
			if (s.equals("+")) {
				...
				if (mode.equals("mul")
						|| mode.equals("div") && !s.equals("+") && !s.equals("-") && !s.equals("X") && !s.equals("÷")) {
